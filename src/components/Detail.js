        ...
        return (
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label="최대 단어 갯수" type="number" name="maxCount" value={this.state.maxCount} onChange={this.handleValueChange} /><br/>
                        <TextField label="최소 단어 길이" type="number" name="minLength" value={this.state.minLength} onChange={this.handleValueChange} /><br/>
                    </DialogContent>
                    <DialogActions>
                        <Button varient="contained" color="primary" onClick={this.handleSubmit}>
                            {(this.state.imageUrl) == 'NONE'? '만들기':'다시 만들기'}
                        </Button>
                        <Button varient="outlined" color="primary" onClick={this.handleDialogToggle}>
                            닫기
                        </Button>
                    </DialogActions>
                </Dialog>
